  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-95',
  {
    variants: {
      variant: {
        ...
        glass: 'bg-glass-light-surface backdrop-blur-glass border border-glass-light-border text-foreground hover:bg-glass-light-surface/80',
        like: 'bg-action-like text-white hover:bg-action-like/90 shadow-lg',
        superlike: 'bg-action-superlike text-white hover:bg-action-superlike/90 shadow-lg',
        pass: 'bg-action-pass text-white hover:bg-action-pass/90 shadow-lg',
      },
      size: {
